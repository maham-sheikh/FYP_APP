...
function Homes() {
  ...
  const renderRequests = () => {
    if (loadingRequests) {
      return (
        <ActivityIndicator size="small" color="#00B1D0" style={styles.loader} />
      );
    }
              ...
              >
                <View style={styles.sliderWrapper}>
                  <View style={styles.sliderBox}>
                    <Image source={service.image} style={styles.sliderImage} />
                  </View>
          ...
          <View style={styles.addC1}>
            ...
            <View style={styles.addC3}>
              <Text style={styles.addT1}>
                Join us and reach an audience that's 40% more likely to convert
                into loyal customers. Boost your sales and watch your business
                grow!
              </Text>
              <TouchableOpacity
